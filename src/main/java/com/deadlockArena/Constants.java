...
public class Constants {
	...
	public static final double[][] coords = { BerserkerCoord, { sC1[0] + BASE * 0, sC1[1] + BASE * 0 }, CyborgCoord,
			{ sC1[0] + BASE * 0, sC1[1] + BASE * 1 }, AssassinCoord, { sC1[0] + BASE * 0, sC1[1] + BASE * 2 },
			TricksterCoord, { sC1[0] + BASE * 1, sC1[1] + BASE * 1 }, MonkCoord,
			{ sC1[0] + BASE * 1, sC1[1] + BASE * 2 }, BardCoord, { sC1[0] + BASE * 1, sC1[1] + BASE * 3 },
			SwordMageCoord, { sC1[0] + BASE * 2, sC1[1] + BASE * 0 }, ChemistCoord,
			{ sC1[0] + BASE * 2, sC1[1] + BASE * 1 }, SniperCoord, { sC1[0] + BASE * 2, sC1[1] + BASE * 2 },
			KnightCoord, { sC2[0] + BASE * 3, sC2[1] + BASE * 3 }, ScreamerCoord,
			{ sC2[0] + BASE * 3, sC2[1] + BASE * 1 }, PyromancerCoord, { sC2[0] + BASE * 0, sC2[1] + BASE * 0 },
			DancerCoord, { sC2[0] + BASE * 1, sC2[1] + BASE * 2 }, EngineerCoord,
			{ sC2[0] + BASE * 3, sC2[1] + BASE * 2 }, DragoonCoord, { sC2[0] + BASE * 2, sC2[1] + BASE * 3 },
			GuardianCoord, { sC2[0] + BASE * 0, sC2[1] + BASE * 1 }, HolyKnightCoord,
			{ sC2[0] + BASE * 1, sC2[1] + BASE * 0 }, ReaperCoord, { sC2[0] + BASE * 2, sC2[1] + BASE * 0 }, };
